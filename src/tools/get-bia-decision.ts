...
export const getBiaDecisionSchema = {
  ...
  description:
    "Fetch the full text of a precedential BIA or Attorney General decision " +
  ...
  inputSchema: {
    ...
    properties: {
      id: {
        type: "string",
        description:
          'Interim decision number, e.g. "4084". Returned as "id" by search_bia_decisions.',
      },
      citation: {
        type: "string",
        description:
          'I&N Dec. citation, e.g. "28 I&N Dec. 883". Used only if "id" is not given.',
      },
    },
    required: [],
  },
...
export async function getBiaDecisionHandler(input: unknown) {
