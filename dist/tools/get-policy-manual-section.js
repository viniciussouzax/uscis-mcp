...
export const getPolicyManualSectionSchema = {
    ...
    inputSchema: {
        ...
        properties: {
            slug: {
                type: "string",
                description: 'Policy manual slug, e.g. "volume-1-part-a-chapter-1", ' +
...
const Args = z.object({
    slug: z
        .string()
        .regex(SLUG_REGEX, 'Slug must match a pattern like "volume-1", "volume-1-part-a", or "volume-1-part-a-chapter-1"'),
});
export async function getPolicyManualSectionHandler(input) {
