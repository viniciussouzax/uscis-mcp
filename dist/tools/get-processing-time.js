...
export const getProcessingTimeSchema = {
    ...
    inputSchema: {
        ...
        properties: {
            ...
            form_type: {
                type: "string",
                description: "Optional sub-category key (e.g. employment-based vs family-based). " +
            ...
            list_options: {
                type: "boolean",
                description: "If true, returns the list of available form_type and office_code options " +
...
export async function getProcessingTimeHandler(input) {
